...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "KitabGhar" },
      { name: "description", content: "A premium digital bookstore and learning environment." },
      { property: "og:title", content: "KitabGhar" },
      { property: "og:description", content: "A premium digital bookstore and learning environment." },
